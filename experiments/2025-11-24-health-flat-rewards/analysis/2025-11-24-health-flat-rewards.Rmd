...
pairwise.wilcox.test(
  x = stats_data$CurUpdate_host_parent_entropy_task_sets,
  g = stats_data$sym_condition,
  p.adjust.method = "bonferroni",
  exact = FALSE
)
...
pairwise.wilcox.test(
  x = stats_data$CurUpdate_host_mean_generations,
  g = stats_data$sym_condition,
  p.adjust.method = "bonferroni",
  exact = FALSE
)
...
ggsave(
  file = paste(plot_dir, "manuscript_flat_rewards_host_task_complexity_plt.pdf", sep = "/"),
