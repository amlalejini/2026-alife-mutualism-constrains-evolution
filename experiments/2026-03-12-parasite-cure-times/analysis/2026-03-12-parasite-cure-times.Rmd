~# 2026-03-12 - Parasite Diff Cure Times
...
experiment_slug <- "2026-03-12-parasite-cure-times"
...
para_no_cure_data <- time_data %>% 
  filter(CURE_UPDATES == 0, sym_condition == "parasite")

sliced_time_data <- bind_rows(half_data, quarter_data, three_quarter_data, no_sym_data, para_no_cure_data)
