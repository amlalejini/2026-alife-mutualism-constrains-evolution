...
combos.add_val(
    ...
    [
        "-MUTUALIST_CYCLE_DONATE_MULTIPLIER 0.5",
        "-MUTUALIST_CYCLE_DONATE_MULTIPLIER 1",
        "-MUTUALIST_CYCLE_DONATE_MULTIPLIER 2",
        "-MUTUALIST_CYCLE_DONATE_MULTIPLIER 4",
        "-MUTUALIST_CYCLE_DONATE_MULTIPLIER 8"
    ]
)
