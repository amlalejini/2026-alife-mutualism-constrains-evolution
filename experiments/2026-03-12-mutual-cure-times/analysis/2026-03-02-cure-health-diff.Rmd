~# 2026-03-02 - Cure Mutualist Diff Rewards
...
experiment_slug <- "2026-03-02-cure-health-diff"
...
```{r}
cure_1_data <- time_data %>%
  filter(CURE == 1, update >= 100000)
cure_2_data <- time_data %>% 
  filter(CURE == 0)

sliced_time_data <- bind_rows(cure_1_data, cure_0_data)
