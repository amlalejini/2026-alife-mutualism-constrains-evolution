...
experiment_slug <- "2026-01-14-health-mut-rate"
...
summary_data <- summary_data %>%
  ...
  filter(SGP_MUT_PER_BIT_RATE != "0.1") %>%
  mutate(
    task_credit = paste0(
